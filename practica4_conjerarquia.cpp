...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(2.5f, 5.0f, -4.0f));
		modelaux = model;
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[4]->RenderMesh();

		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.5f, -2.2f, 3.5f));
		model = glm::scale(model, glm::vec3(1.3f, 1.3f, 1.3f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, .0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución
		//se programe cambio entre proyección ortogonal y perspectiva
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.5f, .0f, 0.0f));
		...
		//			model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		//		}
		//		model = glm::translate(model, glm::vec3(2.f, 0.f, 0.0f));
		//		modelaux = model;
		...
		//		model = modelaux;
		//		model = glm::translate(model, glm::vec3(2.f, .0f, .0f));
		//		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//		if (x > 0 and z > 0) {
		//			model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		//		}
		...
		//		model = modelaux;
		//		model = glm::translate(model, glm::vec3(2.6f, 0.f, 0.0f));
		//		modelaux = model;
		...
		////Antenas
		//model = externalModelAux;
		//model = glm::translate(model, glm::vec3(1.f, 1.f, 0.0f));
		//modelaux = model;
		...
		//color = glm::vec3(1.0f, 0.0f, 0.0f);
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10()), glm::vec3(1.0f, 0.0f, .0f));
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//meshList[0]->RenderMesh();
		...
		////Cara
		//model = externalModelAux;
		//model = glm::translate(model, glm::vec3(0.0f, 0.3f, 1.f));
		//modelaux = model;
		//model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		//color = glm::vec3(1.0f, .0f, 0.f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		///*meshList[0]->RenderMesh();*/
		//sp.render();
		...
		//model = externalModelAux;
		//model = glm::translate(model, glm::vec3(0.6f, 0.3f, 1.f));
		//modelaux = model;
		//model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		//color = glm::vec3(1.0f, .0f, 0.f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		//model = externalModelAux;
		//model = glm::translate(model, glm::vec3(-.6f, 0.3f, 1.f));
		//modelaux = model;
		//model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		//color = glm::vec3(1.0f, .0f, 0.f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		//model = externalModelAux;
		//model = glm::translate(model, glm::vec3(0.3f, -0.1f, 1.f));
		//modelaux = model;
		//model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		//color = glm::vec3(1.0f, .0f, 0.f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
