...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		for (int i = 0; i < 18; i += 2) {
			...
			model = glm::rotate(glm::mat4(1.0), glm::radians(rotacion), glm::vec3(1, 1, 1)); // Bucle para iterar sobre los índices que definen la posición de la cara.
			model = glm::rotate(model, glm::radians(-60.f), glm::vec3(0, 0, 1));    // Operaciones de transformación de la matriz de modelo para posicionar y orientar la cara.
