...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	//Estableciendo los límites de rotación, asignando las teclas 
	if (key == GLFW_KEY_T)
	{
	...
	if (key == GLFW_KEY_F)
	{
		if (theWindow->articulacion1 > -10.0) {
			theWindow->articulacion1 -= 5.0;	//pata delantera izquierda hacia atrás
		}
	}
	if (key == GLFW_KEY_Y)
	{
	...
	if (key == GLFW_KEY_G)
	{
		if (theWindow->articulacion2 > -10.0) {
			theWindow->articulacion2 -= 5.0;	//pata delantera derecha hacia atrás
		}
	}
	if (key == GLFW_KEY_U)
	{
	...
	if (key == GLFW_KEY_H)
	{
		if (theWindow->articulacion3 > -10.0) {
			theWindow->articulacion3 -= 5.0;	//pata trasera izquierda hacia atrás
		}
	}
	if (key == GLFW_KEY_I)
	{
	...
	if (key == GLFW_KEY_J)
	{
		if (theWindow->articulacion4 > -10.0) {
			theWindow->articulacion4 -= 5.0;	//pata trasera derecha hacia atrás
		}
	}
	if (key == GLFW_KEY_O)
	{
	...
	if (key == GLFW_KEY_P)
	{
		if (theWindow->articulacion6 < 13.0) {
			theWindow->articulacion6 += 5.0;	//mandíbula hacia arriba
		}
	}
	if (key == GLFW_KEY_L)
	{
		if (theWindow->articulacion6 > -10.0) {
			theWindow->articulacion6 -= 5.0;	//mandíbula hacia abajo
		}
	}
	if (key == GLFW_KEY_V)
	{
